...
function startAstroServer({ label, port, source }) {
  ...
  const child = spawnCommand(command, commandArgs, {
    ...
    env: {
      ...
      PAYLOAD_PUBLIC_SERVER_URL: process.env.PAYLOAD_PUBLIC_SERVER_URL || 'https://cms.matthiasramahi.de',
      PAYLOAD_FETCH_TIMEOUT_MS: process.env.PAYLOAD_FETCH_TIMEOUT_MS || '10000',
      ASTRO_DISABLE_PAYLOAD_FETCH: 'false',
      NO_COLOR: '1',
    },
