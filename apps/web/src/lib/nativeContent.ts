...
export const servicesIndexItems: ServicesIndexItem[] = [
  {
    ...
    images: [
      ...
      {
        className: 'small',
        src: '/assets/optimized/assets-photos-landschaft-1920.webp',
  ...
  },
  {
    ...
    images: [
      ...
      {
        className: 'small',
        src: '/assets/services/catoir_ramahiinuikiim21.webp',
  ...
  },
  {
    ...
    images: [
      {
        className: 'screen',
        src: '/assets/services/screencapture-gr-knospe-de-2025-10-02-23_10_04-scaled.webp',
  ...
  },
  {
    ...
    images: [
      ...
      {
        className: 'small',
        src: '/assets/optimized/assets-photos-automobil-sunset-1920.webp',
