  ...
  },
  {
    ...
    fields: [
      ...
      textField('category', 'Kategorie', {
        description: 'Stabiles Themencluster. Kategorien werden als Journal-Filter genutzt, nicht als eigene SEO-Archive.',
        options: [
          { label: 'Automotive', value: 'automotive' },
          { label: 'Sportwagen', value: 'sports-car' },
          { label: 'Oldtimer', value: 'classic-car' },
      ...
      textField('tags', 'Themen-Tags', {
        description: 'Kontrollierte interne Metadaten. Es werden keine indexierbaren Tag-Archive erzeugt.',
        list: true,
        options: [
          'Automotive',
          'Sportwagen',
