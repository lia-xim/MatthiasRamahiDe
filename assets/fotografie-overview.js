/* Fotografie overview hero — adapted from the homepage WebGL stage. */
(function(){
...
(()=>{
  ...
  const HERO_TEXTS=(hero?.dataset.titleSeq||'Fotografie|Düsseldorf;Automobil;Sportwagen;Oldtimer;Motorrad;Portrait;Landschaft')
    .split(';')
