(function(){
  ...
  if(hero){
    var reduceHeroMotion = matchMedia('(prefers-reduced-motion:reduce)').matches;
    var startHeroMotion = function(){
      if(!reduceHeroMotion) hero.classList.add('is-animated');
    };
    setTimeout(function(){
      if('requestIdleCallback' in window) requestIdleCallback(startHeroMotion, { timeout: 1400 });
